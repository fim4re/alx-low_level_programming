 ...
 *
 * Description: If the file is not - exit code 98.
*/
void check_elf(unsigned char *e_ident)
{
	int index;
...
/**
 * print_magic - Prints the magic numbers ELF
 * @e_ident: array containing the ELF magic numbers
 *
*/
void print_magic(unsigned char *e_ident)
 ...
 * @e_ident: A array containing the ELF class
*/
void print_class(unsigned char *e_ident)
{
	printf("  Class:                             ");
...
/**
 * print_abi - the ABI version of an ELF
...
/**
 * print_entry - the entry point of an ELF
